...
def makeJECTable(massbins, outroot,  *plots):
    ...
    pt.Draw()
    c1.Update()
    c1.SaveAs(plotloc+"VBFeffJecall.png")
    c1.SaveAs(plotloc+"VBFeffJecall.eps")
    c1.SaveAs(plotloc+"VBFeffJecall.root")
    c1.SaveAs(plotloc+"VBFeffJecall.pdf")
    ...
    pt.Draw()
    c2.Update()
    c2.SaveAs(plotloc+"VBFeffJec100all.png")
    c2.SaveAs(plotloc+"VBFeffJec100all.eps")
    c2.SaveAs(plotloc+"VBFeffJec100all.root")
    c2.SaveAs(plotloc+"VBFeffJec100all.pdf")
...
#            makeJECTable([100, 150],  'outjec125.root', *plots)
