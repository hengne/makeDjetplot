...
class TreePlot(Plot):
    ...
    def vbf_eff_qcd(self, bins=None):
        ...
        return eff_ct,eff_ct_err,eff_qcd,eff_qcd_err,n_pass_qcd,n_fail_qcd,n_pass_ct,n_fail_ct
...
def makeQCDTable(massbins, outroot,  *plots):
    ...
    for plot in plots:
        ...
        eff_ct,eff_ct_err,eff_qcd,eff_qcd_err,n_pass_qcd,n_fail_qcd,n_pass_ct,n_fail_ct = plot.vbf_eff_qcd(bins)
...
#        if plot.title != "Z+X" : 
    ...
    pt.Draw()
    c1.Update()
    c1.SaveAs(plotloc+"VBFeffQCDfixDnom.png")
    c1.SaveAs(plotloc+"VBFeffQCDfixDnom.eps")
    c1.SaveAs(plotloc+"VBFeffQCDfixDnom.root")
    c1.SaveAs(plotloc+"VBFeffQCDfixDnom.pdf")
    ...
    pt.Draw()
    c2.Update()
    c2.SaveAs(plotloc+"VBFeffQCD100fixDnom.png")
    c2.SaveAs(plotloc+"VBFeffQCD100fixDnom.eps")
    c2.SaveAs(plotloc+"VBFeffQCD100fixDnom.root")
    c2.SaveAs(plotloc+"VBFeffQCD100fixDnom.pdf")
...
#            makeQCDTable([100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 300, 400, 500, 600, 700, 800, 900, 1000], *plots)
            makeQCDTable([100, 500],  'outqcdfixdenom.root', *plots)
