...
#        if plot.title != "Z+X" : 
    ...
    pt.Draw()
    c1.Update()
    c1.SaveAs(plotloc+"VBFeffPU.png")
    c1.SaveAs(plotloc+"VBFeffPU.eps")
    c1.SaveAs(plotloc+"VBFeffPU.root")
    c1.SaveAs(plotloc+"VBFeffPU.pdf")
    ...
    pt.Draw()
    c2.Update()
    c2.SaveAs(plotloc+"VBFeffPU100.png")
    c2.SaveAs(plotloc+"VBFeffPU100.eps")
    c2.SaveAs(plotloc+"VBFeffPU100.root")
    c2.SaveAs(plotloc+"VBFeffPU100.pdf")
...
#            makePUTable([100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 300, 400, 500, 600, 700, 800, 900, 1000], *plots)
